    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (selection > 0 && selection < 3)
            {
                ...
                {
                    Console.WriteLine("Menu:");
                    Console.WriteLine("1. Separators");
        ...
        public static void SizeDecryption()
        {
            ...
            String arr = "";
            int size = 0;
            string text = document.Sections[0].Body.Paragraphs[1].Runs[0].Text;
        ...
        {
            //Initialization 
            Document document = new Document("sample file1.docx");
            Document saveDoc = new Document("encrypted_file.docx");
            DocumentBuilder builder = new DocumentBuilder(saveDoc);
            ...
            for(int i = 0;i< stringBuilder.Length; i++)
            {
                ...
                if(stringBuilder[i] == ' ')
                {
                    ...
                    {
                        String additional = bin[counter] == '0' ? "" : " ";
                        stringBuilder.Insert(i, additional);
                        counter++;
                        i++;
                    }
                    else if(counter == bin.Length)
                    {
            ...
            saveDoc.Save("encrypted_file.docx");
        }
